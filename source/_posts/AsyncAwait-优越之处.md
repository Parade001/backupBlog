---
layout: post
title: AsyncAwait 优越之处
abbrlink: 38372
date: 2022-05-10 22:37:36
tags: async await
categories: JavaScript
summary: 前端异步问题处理一直是一个老大难的问题，前有 Callback Hell 的绝望，后有 Promise/Deferred 的规范混战，从 Generator 配合 co 所向披靡，到如今 Async/Await 改变世界。
---
